...
addToCart.forEach(function (btn) {
  btn.addEventListener("click", function (e) {
    console.log(e); //let pizza = btn.dataset.pizza; // iseh hum data mil jayega JSON k formate mei
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkrealtimewebapp_nodejs_ejs_mongodb"] = self["webpackChunkrealtimewebapp_nodejs_ejs_mongodb"] || [];
